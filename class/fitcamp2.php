...
echo "<h4>Has Seleccionado: " . $selected . "</h4>";
         ...
         if(file_exists($estructura1)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','FitCamp','$estructura1','$folder','$value')";
        ...
        if(file_exists($estructura2)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','Fitcamp','$estructura2','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
        ...
        if ($value == 'Dominicana') {
                $estructura3 = "../../rdfitcamp/".$folder;
                 ...
                 //creamos directorio para Dominicana
        if(file_exists($estructura3)){
            ...
            echo "<script> 
                alert('El nombre de la Carpeta existe en República Dominicana')
                </script>";

            echo("<h3>Capturadora Creada Satisfactoriamente en República Dominicana</h3><br>");
            echo("El nombre de la Carpeta existe e<br><br>");
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','rdfitcamp','$estructura3','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
             ...
             echo "<script> 
                alert('Creado Satisfactoriamente en Dominicana')
                </script>";
