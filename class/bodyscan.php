...
<div class="container">
  <div class="row">
    <div class="col-md-6" style="margin-top:60px;">
      ...
      <span class="video-link" data-video-id="'.$idvideo1.$video1.'">
        <img src="../assets/images/video-fake.jpg" width="100%" height="auto">
      </span>

      <span class="video-link" data-video-id="'.$idvideo1.$video1.'" data-video-width="1280px" data-video-height="720px" data-video-autoplay="1" ></span>
            ...
            <tr>
              ...
              foreach ($file as $mail) {
                if(mail($mail, $asunto, $mensaje, $headers)) {
                  ...
                  $i++;
                  $insert = "INSERT INTO emails(id_coach,firstname,lastname,email,phone,web) VALUES(\'".$id_coach."\',\'".$firstname."\',\'".$lastname."\',\'".$arquivo."\',\'".$Phone."\',\'BodyScan\')";
