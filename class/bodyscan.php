    ...
    <dic class="col-md-6">
      <div class="form-part wow fadeInDown">
        ...
        <form method="post" action="http://planhbl.com/hecoweb/email/email01.php">
          <input name="web" value="bodyscanco" type="hidden">
          <input type="hidden" name="id_coach" value="'.$id_coach.'">
          <input type="hidden" name="subject" value="Body Scan - Scanner Corporal">
...
<dic class="col-md-6">
      <div class="form-part wow fadeInDown">
        ...
        <form method="post" action="http://planhbl.com/hecoweb/email/email01.php">
          ...
          <input type="hidden" name="id_coach" value="'.$id_coach.'">
          <input type="hidden" name="subject" value="Body Scan">
          <div class="form-group">
            <input type="name" name="firstname" class="form-control" placeholder="Nombre" required></div>
          <div class="form-group">
            <input type="lastname" name="lastname" class="form-control" placeholder="Apellido" required></div>
...
/******************************************************************************************************/
/**************************CREA EL CLON DE KA WEB DE Republica Dominicana******************************/
/******************************************************************************************************/
  ...
  <div class="row">
    ...
    <dic class="col-md-6">
      <div class="form-part wow fadeInDown">
        ...
        <p>Rellena este formulario para empezar ahora!</p>
        <form method="post" action="http://planhbl.com/hecoweb/email/email01.php">
          <input name="web" value="rdBodyscan" type="hidden">
          <input type="hidden" name="activity_id" value="15">
          <input type="hidden" name="id_coach" value="'.$id_coach.'">
          <input type="hidden" name="subject" value="Body Scan">
          <div class="form-group">
  ...
  <div class="row">
    ...
    <dic class="col-md-6">
      <div class="form-part wow fadeInDown">
        ...
        <p>Rellena este formulario para empezar ahora!</p>
        <form method="post" action="http://planhbl.com/hecoweb/email/email01.php">
          <input name="web" value="BodyScan" type="hidden">
          <input type="hidden" name="activity_id" value="15">
          <input type="hidden" name="id_coach" value="'.$id_coach.'">
          <input type="hidden" name="subject" value="Body Scan">
          <div class="form-group">
...
echo "<h4>Has Seleccionado: " . $selected . "</h4>";
         ...
         if(file_exists($estructura1)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach','BodyScan','$estructura1','$folder','$value')";
        ...
        if(file_exists($estructura2)){
            ...
            echo "<script> 
                alert('El nombre de la Carpeta existe e on USA')
                </script>";

            echo("<h3>Capturadora Creada Satisfactoriamente en USA</h3><br>");
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach','bodyscan','$estructura2','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
             ...
             echo "<script> 
                alert('Creado Satisfactoriamente en USA')
                </script>";
        ...
        if(file_exists($estructura3)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach','rdBodyscan','$estructura3','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
...
<div class="container">
    <div class="row">
        <form action="bodyscan.php" method="POST">
...
<br>
          ...
          <label for="name">Seleccione un Entrenador</label>
            ...
            <div class="inner-addon left-addon">
              ...
              <input type="checkbox" name="web[]" value="USA"/> USA <br/>
