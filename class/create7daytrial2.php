...
echo "<h4>Se ha creado la Capturadora correctamente en: </h4>";
        ...
        if(file_exists($estructura2)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','7diastrial','$estructura2','$folder','$value')";
...
<div class="container">
    <div class="row">
        <form action="create7daytrial2.php" method="POST">
            <!--<h3>Create Web 3daytrial Challenge</h3>-->
            <h3>Creación del WebSite Reto del Paquete de 7 días</h3>
<br>
