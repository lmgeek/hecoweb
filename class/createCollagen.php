...
';
        ...
        if(file_exists($estructura)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach','Collagen','$estructura','$folder','USA')";
              if ($conexion->query($insert) == TRUE) {
              }else{
...
<br>
          ...
          <label for="name">Selecion un Entrenador</label>
