...
echo "<h4>Ha Seleccionado Capturadoras a crear en: " . $selected . "</h4>";
         ...
         if(file_exists($estructura1)){
            ...
            echo "<script> 
                alert('Se ha creado satisfactoriamente en Estados Unidos')
                </script>";
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','3daytrial','$estructura1','$folder','$value')";
        ...
        if(file_exists($estructura2)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','3dt','$estructura2','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
            ...
            echo "<br/>";
            $host= $_SERVER["HTTP_HOST"];
            echo "<input type='text' class='form-control' value='http://" . $estructura2 . "'>";
            echo "<br>";*/
            ...
            if ($value == 'Dominicana') {
                $estructura3 = "../../3dt/".$folder;

                 //creamos directorio para Reublica Dominicana
        if(file_exists($estructura3)){
            ...
            echo "<script> 
                alert('El nombre de la carpeta para la web de Reublica Dominicana existe Verifique y vuelva a intentar')
                </script>";

            echo("<h3>Capturadora en Reublica Dominicana:</h3><br>");
            echo("El nombre de la carpeta para la web de Reublica Dominicana existe Verifique y vuelva a intentar<br><br>");
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','3dt','$estructura3','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
            ...
            echo "<br/>";
            $host= $_SERVER["HTTP_HOST"];
            echo "<input type='text' class='form-control' value='http://" . $estructura3 . "'>";
            echo "<br>";*/
...
<div class="container">
    <div class="row">
        <form action="create3daytrial2.php" method="POST">
