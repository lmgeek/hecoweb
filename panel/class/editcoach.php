...
$email = $_POST['email'];
    ...
    if ($conexion->query("UPDATE `coach` SET `name` = '".$name."',`phone` = '".$phone."',`phone2` = '".$phone2."',`phone3` = '".$phone3."',`email` = '".$email."' WHERE `id` = ".$id) == TRUE) {
  ...
  <br>
            <div class="form-group col-xs-6">
                    <?php
                    $resultado = $conexion->query("SELECT * FROM coach WHERE id = ".$idcoach);
