...
<?php
  ...
  $search = $conexion->query(\'SELECT * FROM coach WHERE name ="'.$id_coach_lead.'"\');
...
echo "<h4>Ha Seleccionado Capturadoras a crear en: " . $selected . "</h4>";
        ...
        if(file_exists($estructura2)){
            ...
            $insert = "INSERT INTO webcoach(coach,web,dir_name,folder,country) VALUES('$id_coach_lead','3dt','$estructura1','$folder','$value')";
              if ($conexion->query($insert) == TRUE) {
              }else{
