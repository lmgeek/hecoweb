...
$con = @mysqli_connect('localhost', 'thrdaytr_webapp', 'pRf_&lue#LU7', 'thrdaytr_planhbl') or die("document.write('Error');");
...
if (isset($_COOKIE[md5($enlace)])) {
    ...
    if ($rows > 0) {
        ...
        if (mysqli_query($con, $SQL)) { // Si se inserta la visita
            ...
            setcookie(md5($enlace), '_vStD', time() + 3600); // Y creamos la cookie de 1 hora
